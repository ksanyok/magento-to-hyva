define([], function () {
    return {
        ...
        getItemHtml: function ({item, components, html}) {
			// Get the short description or empty string
			let desc = item.short_description ? item.short_description : '';

			// Strip HTML tags using a temporary DOM element
			const tempDiv = document.createElement('div');
			tempDiv.innerHTML = desc;
			desc = tempDiv.textContent || tempDiv.innerText || '';

			// create a string containing the rendered HTML
			return html`<a class="algoliasearch-autocomplete-hit"
				...
				<div class="info">
					...
					<div class="description">${html([desc])}</div>
