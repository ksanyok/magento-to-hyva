...
return [
    'modules' => [
        ...
        'Mageplaza_StoreLocator' => 1,
        'Magestall_GuestWishlist' => 1,
        'Makewebbetter_HubIntegration' => 1,
        'Makewebbetter_HubGuestUser' => 1,
        'MediaDivision_Basics' => 1,
        'MediaDivision_CheckoutSteps' => 1,
        'MediaDivision_Image' => 1,
        'MediaDivision_Magmi' => 1,
        'MediaDivision_ShippingMethods' => 1,
        'MediaDivision_Store' => 1,
        'MediaDivision_StoreLocator' => 1,
        'MediaDivision_SwatchImages' => 1,
        'MediaDivision_TexData' => 1,
        'Mirasvit_Core' => 1,
        'Mirasvit_Misspell' => 1,
        'Mirasvit_Report' => 1,
        'Mirasvit_Rma' => 1,
        ...
        'Xtento_XtCore' => 1,
        'Yireo_AdminSimpleSearchFields' => 1,
